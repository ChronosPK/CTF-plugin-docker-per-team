...
class ContainerInfoModel(db.Model):
    __table_args__ = (
        db.UniqueConstraint("challenge_id", "team_id", name="uq_container_info_challenge_team"),
        db.UniqueConstraint("challenge_id", "user_id", name="uq_container_info_challenge_user"),
        db.Index("idx_container_info_team_challenge", "team_id", "challenge_id"),
        db.Index("idx_container_info_user_challenge", "user_id", "challenge_id"),
        db.Index("idx_container_info_expires", "expires"),
    )
...
class ContainerFlagModel(db.Model):
    __table_args__ = (
        db.Index("idx_container_flag_container_id", "container_id"),
        db.Index("idx_container_flag_team_challenge", "team_id", "challenge_id"),
        db.Index("idx_container_flag_user_challenge", "user_id", "challenge_id"),
    )
